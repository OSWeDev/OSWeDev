...
describe('VarsDatasVoUpdateHandler', () => {
    ...
    it('test filter_var_datas_by_indexes', async () => {
        ...
        await VarsDatasProxy.getInstance()['filter_var_datas_by_indexes'](var_datas, null, true, 'test filter_var_datas_by_indexes', donot_insert_if_absent, just_been_loaded_from_db);
    });
});