...
export default class FakeCyclicalDataHandler {
    ...
    public static zero_cinq: moment.Moment = moment(FakeCyclicalDataHandler.zero).utc(true).add(12, 'hour');
    public static moins_zero_cinq: moment.Moment = moment(FakeCyclicalDataHandler.zero).utc(true).add(-12, 'hour');
    public static un: moment.Moment = moment(FakeCyclicalDataHandler.zero).utc(true).add(1, 'day');
    public static deux: moment.Moment = moment(FakeCyclicalDataHandler.zero).utc(true).add(2, 'day');
    public static moins_un: moment.Moment = moment(FakeCyclicalDataHandler.zero).utc(true).add(-1, 'day');
    public static moins_deux: moment.Moment = moment(FakeCyclicalDataHandler.zero).utc(true).add(-2, 'day');
