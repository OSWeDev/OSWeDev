...
export default class Patch20210727ChangeProgramPlanDatesType implements IGeneratorWorker {

    public static getInstance(): Patch20210727ChangeProgramPlanDatesType {
        if (!Patch20210727ChangeProgramPlanDatesType.instance) {
            Patch20210727ChangeProgramPlanDatesType.instance = new Patch20210727ChangeProgramPlanDatesType();
        }
        return Patch20210727ChangeProgramPlanDatesType.instance;
    }

    private static instance: Patch20210727ChangeProgramPlanDatesType = null;

    get uid(): string {
        return 'Patch20210727ChangeProgramPlanDatesType';
    }
