...
export default class Patch20201006InitFrontVarsPolicies implements IGeneratorWorker {

    public static getInstance(): Patch20201006InitFrontVarsPolicies {
        if (!Patch20201006InitFrontVarsPolicies.instance) {
            Patch20201006InitFrontVarsPolicies.instance = new Patch20201006InitFrontVarsPolicies();
        }
        return Patch20201006InitFrontVarsPolicies.instance;
    }

    private static instance: Patch20201006InitFrontVarsPolicies = null;

    get uid(): string {
        return 'Patch20201006InitFrontVarsPolicies';
    }
