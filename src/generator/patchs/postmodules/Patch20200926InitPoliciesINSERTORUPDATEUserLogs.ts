...
export default class Patch20200926InitPoliciesINSERTORUPDATEUserLogs implements IGeneratorWorker {

    public static getInstance(): Patch20200926InitPoliciesINSERTORUPDATEUserLogs {
        if (!Patch20200926InitPoliciesINSERTORUPDATEUserLogs.instance) {
            Patch20200926InitPoliciesINSERTORUPDATEUserLogs.instance = new Patch20200926InitPoliciesINSERTORUPDATEUserLogs();
        }
        return Patch20200926InitPoliciesINSERTORUPDATEUserLogs.instance;
    }

    private static instance: Patch20200926InitPoliciesINSERTORUPDATEUserLogs = null;

    get uid(): string {
        return 'Patch20200926InitPoliciesINSERTORUPDATEUserLogs';
    }
