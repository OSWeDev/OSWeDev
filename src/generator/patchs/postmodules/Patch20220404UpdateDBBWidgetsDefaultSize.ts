...
export default class Patch20220404UpdateDBBWidgetsDefaultSize implements IGeneratorWorker {
    ...
    public async work(db: IDatabase<any>) {
        ...
        if (BulkOps) {
            ...
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(BulkOps);
        }
        ...
        if (Checklist) {
            ...
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(Checklist);
        }
        ...
        if (fieldValueFilter) {
            ...
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(fieldValueFilter);
        }
        ...
        if (DOWFilter) {
            ...
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(DOWFilter);
        }
        ...
        if (MonthFilter) {
            ...
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(MonthFilter);
        }
        ...
        if (YearFilter) {
            ...
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(YearFilter);
        }
        ...
        if (var_widget) {
            ...
            var_widget.name = 'var';
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(var_widget);
        }
        ...
        if (pageswitch_widget) {
            ...
            await ModuleDAOServer.instance.insertOrUpdateVO_as_server(pageswitch_widget);
        }
    }
}