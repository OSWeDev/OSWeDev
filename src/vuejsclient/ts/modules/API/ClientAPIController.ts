        ...
        switch (apiDefinition.api_type) {
            case APIDefinition.API_TYPE_GET:
                ...
                api_res = await AjaxCacheClientController.getInstance().get(
                    ...
                    (!EnvHandler.MSGPCK) ? 'application/json; charset=utf-8' : AjaxCacheController.MSGPACK_REQUEST_TYPE) as U;
                break;
            ...
            case APIDefinition.API_TYPE_POST_FOR_GET:
                ...
                api_res = await AjaxCacheClientController.getInstance().get(
                    ...
                    API_TYPES_IDS_involved,
                    ((typeof translated_param != 'undefined') && (translated_param != null)) ? ((!EnvHandler.MSGPCK) ? JSON.stringify(APIControllerWrapper.getInstance().try_translate_vos_to_api(translated_param)) : APIControllerWrapper.getInstance().try_translate_vos_to_api(translated_param)) : null,
                    null,
            ...
            case APIDefinition.API_TYPE_POST:
                if (apiDefinition.api_return_type == APIDefinition.API_RETURN_TYPE_FILE) {
                    ...
                    let filePath: string = await AjaxCacheClientController.getInstance().post(
                        ...
                        ((typeof translated_param != 'undefined') && (translated_param != null)) ? ((!EnvHandler.MSGPCK) ? JSON.stringify(APIControllerWrapper.getInstance().try_translate_vos_to_api(translated_param)) : APIControllerWrapper.getInstance().try_translate_vos_to_api(translated_param)) : null,
                        null,
                        (!EnvHandler.MSGPCK) ? 'application/json; charset=utf-8' : AjaxCacheController.MSGPACK_REQUEST_TYPE) as string;
