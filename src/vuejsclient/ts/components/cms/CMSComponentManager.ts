...
export default class CMSComponentManager {
    ...
    public template_component_vue_by_type_id: { [api_type_id: string]: ICMSComponentTemplateVue } = {};

    public registerCMSTemplateComponent(type_id: string, vueComponent: ICMSComponentTemplateVue) {
