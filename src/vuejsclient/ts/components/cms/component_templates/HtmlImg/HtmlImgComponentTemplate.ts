...
import './HtmlImgComponentTemplate.scss';
...
@Component({
    template: require('./HtmlImgComponentTemplate.pug'),
    components: {}
})
export default class HtmlImgComponentTemplate extends VueComponentBase implements ICMSComponentTemplateVue {
