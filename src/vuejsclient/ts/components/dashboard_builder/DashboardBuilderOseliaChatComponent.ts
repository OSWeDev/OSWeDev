...
export default class DashboardBuilderOseliaChatComponent extends VueComponentBase {

    public static GridLayout_TOTAL_HEIGHT: number = 720;
    public static GridLayout_TOTAL_ROWS: number = 72;
    public static GridLayout_ELT_HEIGHT: number = DashboardBuilderOseliaChatComponent.GridLayout_TOTAL_HEIGHT / DashboardBuilderOseliaChatComponent.GridLayout_TOTAL_ROWS;
    ...
    private elt_height: number = DashboardBuilderOseliaChatComponent.GridLayout_ELT_HEIGHT;
    private col_num: number = DashboardBuilderOseliaChatComponent.GridLayout_TOTAL_COLUMNS;
    private max_rows: number = DashboardBuilderOseliaChatComponent.GridLayout_TOTAL_ROWS;
    ...
    private async add_widget_to_page(widget: DashboardWidgetVO): Promise<DashboardPageWidgetVO> {
        ...
        return new Promise((resolvef, rejectf) => {
            const self = this;
            self.snotify.async(
                self.label('DashboardBuilderOseliaChatComponent.add_widget_to_page.start'), () =>
                new Promise(async (resolve, reject) => {
                    ...
                    resolve({
                        body: self.label('DashboardBuilderOseliaChatComponent.add_widget_to_page.ok'),
                        config: {
                            timeout: 10000,
                            showProgressBar: true,
                            closeOnClick: false,
    ...
    private async delete_widget(page_widget: DashboardPageWidgetVO) {
        ...
        self.snotify.confirm(self.label('DashboardBuilderOseliaChatComponent.delete_widget.body'), self.label('DashboardBuilderOseliaChatComponent.delete_widget.title'), {
            timeout: 10000,
            showProgressBar: true,
            closeOnClick: false,
            pauseOnHover: true,
            buttons: [
                {
                    ...
                    action: async (toast) => {
                        ...
                        self.snotify.async(
                            self.label('DashboardBuilderOseliaChatComponent.delete_widget.start'),
                            () => new Promise(async (resolve, reject) => {
                                ...
                                try {
                                    ...
                                    resolve({
                                        body: self.label('DashboardBuilderOseliaChatComponent.delete_widget.ok'),
                                        config: {
                                            timeout: 10000,
                                            showProgressBar: true,
                                            closeOnClick: false,
