...
export default class DroppableVosStore implements IStoreModule<IDroppableVosState, DroppableVosContext> {
    ...
    public mutations: MutationTree<IDroppableVosState>;
    ...
    protected constructor() {
        ...
        this.actions = {
            set_selected_vos(context: DroppableVosContext, selected_vos: { [api_type_id: string]: boolean }) {
                commit_set_selected_vos(context, selected_vos);
            },
            set_filter_by_api_type_id(context: DroppableVosContext, filter_by_api_type_id: string) {
                commit_set_filter_by_api_type_id(context, filter_by_api_type_id);
            },
            switch_selected_field(context: DroppableVosContext, api_type_id: string) {
                commit_switch_selected_field(context, api_type_id);
            }
        };
    }
}
...
export const commit_set_selected_vos = commit(DroppableVosStoreInstance.mutations.set_selected_vos);
export const commit_switch_selected_field = commit(DroppableVosStoreInstance.mutations.switch_selected_field);
export const commit_set_filter_by_api_type_id = commit(DroppableVosStoreInstance.mutations.set_filter_by_api_type_id);