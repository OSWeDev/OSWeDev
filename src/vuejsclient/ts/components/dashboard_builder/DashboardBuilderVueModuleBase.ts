...
export default class DashboardBuilderVueModuleBase extends VueModuleBase {
    ...
    private async initializeWidget_DataTable() {
        ...
        await DashboardBuilderWidgetsController.getInstance().registerWidget(Table, () => new TableWidgetOptions(null, true, 100, null, false, true, false, true, true, true, true, true, true, true, true, false, null, false, false, null, null, null, false, null), TableWidgetOptions.get_selected_fields);
    ...
    private async initializeWidget_ValueTable() {
        ...
        await DashboardBuilderWidgetsController.getInstance().registerWidget(Table, () => new TableWidgetOptions(null, false, 100, null, false, false, false, false, false, true, true, true, true, true, true, false, null, false, false, null, null, null, false, null), TableWidgetOptions.get_selected_fields);
    ...
    private async initializeWidget_FieldValueFilter() {
        ...
        await DashboardBuilderWidgetsController.getInstance().registerWidget(fieldValueFilter, () => new FieldValueFilterWidgetOptions(null, null, null, true, false, 50, false, false, null, false, AdvancedStringFilter.FILTER_TYPE_CONTIENT, false, false, null, null, null, null, false, false, false, null, null, null, true, null), FieldValueFilterWidgetOptions.get_selected_fields);
