...
export default class DashboardBuilderVueModuleBase extends VueModuleBase {
    ...
    private async initializeWidget_DataTable() {
        ...
        await DashboardBuilderWidgetsController.getInstance().registerWidget(Table, () => new TableWidgetOptions(null, true, 100, null, false, true, false, true, true, true, true, true, true, true, true, false, null, false, 5, false), TableWidgetOptions.get_selected_fields);
    ...
    private async initializeWidget_ValueTable() {
        ...
        await DashboardBuilderWidgetsController.getInstance().registerWidget(Table, () => new TableWidgetOptions(null, false, 100, null, false, false, false, false, false, true, true, true, true, true, true, false, null, false, 5, false), TableWidgetOptions.get_selected_fields);
