...
export default class TableWidgetTableComponent extends VueComponentBase {
    ...
    get columns(): TableColumnDescVO[] {
        ...
        // if (
        //     options.has_column_dynamic &&
        //     options.column_dynamic_page_widget_id &&
        //     (options.column_dynamic_component || options.column_dynamic_var)
        // ) {
        ...
        //                     if (options.column_dynamic_component) {
        //                         new_column.type = TableColumnDescVO.TYPE_component;
        //                         new_column.component_name = options.column_dynamic_component;
        //                     } else if (options.column_dynamic_var) {
        //                         new_column.type = TableColumnDescVO.TYPE_var_ref;
        //                         new_column.var_id = VarsController.var_conf_by_name[options.column_dynamic_var].id;
        //                         new_column.var_unicity_id = Dates.now();
        //                     }
