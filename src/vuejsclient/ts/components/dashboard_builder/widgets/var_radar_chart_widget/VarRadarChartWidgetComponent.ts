...
export default class VarRadarChartWidgetComponent extends VueComponentBase implements IDashboardPageConsumer {
    ...
    private has_widget_validation_filtres(): boolean {
        ...
        for (let i in this.all_page_widget) {
            let widget: DashboardWidgetVO = this.get_widgets_by_id[this.all_page_widget[i].widget_id];
