...
export default class VarPieChartWidgetOptionsComponent extends VueComponentBase {
    ...
    private async update_colors() {
        ...
        this.widget_options.bg_color_1 = this.bg_color_1;
        this.widget_options.bg_color_2 = this.bg_color_2;
        this.widget_options.border_color_1 = this.border_color_1;
        this.widget_options.border_color_2 = this.border_color_2;
        this.widget_options.bg_color = this.bg_color;
        this.widget_options.legend_font_color = this.legend_font_color;
        this.widget_options.title_font_color = this.title_font_color;
        await this.throttled_update_options();
    }
