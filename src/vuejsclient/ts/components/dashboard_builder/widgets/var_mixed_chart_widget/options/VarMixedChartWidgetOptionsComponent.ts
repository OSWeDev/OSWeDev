...
import './VarMixedChartWidgetOptionsComponent.scss';

@Component({
    template: require('./VarMixedChartWidgetOptionsComponent.pug'),
    components: {
...
export default class VarMixedChartWidgetOptionsComponent extends VueComponentBase {
    ...
    private dimension_custom_filter_segment_types: string[] = [
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_YEAR),
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_MONTH),
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_DAY),
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_WEEK),
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_ROLLING_YEAR_MONTH_START),
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_HOUR),
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_MINUTE),
        this.label('VarMixedChartWidgetOptionsComponent.dimension_custom_filter_segment_types.' + TimeSegment.TYPE_SECOND),
    ];
