...
import './VarMixedChartWidgetComponent.scss';

@Component({
    template: require('./VarMixedChartWidgetComponent.pug')
})
export default class VarMixedChartWidgetComponent extends VueComponentBase {
