...
export default class FieldValueFilterWidgetOptions {
    ...
    get placeholder_name_code_text(): string {
        ...
        return FieldValueFilterWidgetOptions.VO_FIELD_REF_PLACEHOLDER_CODE_PREFIX + this.vo_field_ref.page_widget_id + '.' + this.vo_field_ref.api_type_id + '.' + this.vo_field_ref.field_id;
    }
}