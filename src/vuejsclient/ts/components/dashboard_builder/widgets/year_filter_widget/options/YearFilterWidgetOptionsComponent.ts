...
export default class YearFilterWidgetOptionsComponent extends VueComponentBase {
    ...
    private onchange_widget_options() {
        ...
        this.min_year = this.widget_options.min_year;
        this.max_year = this.widget_options.max_year;
    }
    ...
    private async onchange_min_year() {
        ...
        if (this.widget_options.min_year != this.min_year) {
            this.next_update_options = this.widget_options;
            this.next_update_options.min_year = this.min_year;
    ...
    private async onchange_max_year() {
        ...
        if (this.widget_options.max_year != this.max_year) {
            this.next_update_options = this.widget_options;
            this.next_update_options.max_year = this.max_year;
    ...
    private async switch_is_vo_field_ref() {
        ...
        if (!this.next_update_options) {
            this.next_update_options = new YearFilterWidgetOptions(this.is_vo_field_ref, null, null, null, null);
        }
