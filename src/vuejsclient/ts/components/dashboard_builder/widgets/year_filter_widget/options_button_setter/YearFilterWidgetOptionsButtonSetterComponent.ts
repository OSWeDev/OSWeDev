...
export default class YearFilterWidgetOptionsButtonSetterComponent extends VueComponentBase implements IDashboardPageConsumer {
    ...
    private throttled_update_page_widget = ThrottleHelper.declare_throttle_without_args(
        'YearFilterWidgetOptionsButtonSetterComponent.throttled_update_page_widget',
    ...
    private can_configure_auto_select_year_relative_mode: boolean = true;
    ...
    private throttled_load_all_years_page_widgets = ThrottleHelper.declare_throttle_without_args(
        'YearFilterWidgetOptionsButtonSetterComponent.throttled_load_all_years_page_widgets',
