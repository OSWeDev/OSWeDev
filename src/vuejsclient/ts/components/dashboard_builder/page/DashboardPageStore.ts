...
const actions = {
    ...
    set_active_field_filters: (context: DashboardPageContext, active_field_filters: FieldFiltersVO) => context.commit(store_mutations_names(storeInstance).set_active_field_filters, active_field_filters),
