...
export default class CheckListClientVueModule extends VueModuleBase {
    ...
    public async initializeAsync() {
        ...
        let url: string = this.route_base_checklist + "/:checklist_id";
        ...
        this.routes.push({
            ...
            props: (route) => ({
                key: this.checklist_shared_module.name + '_checklist_' + parseInt(route.params.selected_rdv_id),
                checklist_id: parseInt(route.params.checklist_id),
                modal_show: false,
        ...
        url = this.route_base_checklist + "/:checklist_id/:item_id";
        ...
        this.routes.push({
            ...
            component: () => import(/* webpackChunkName: "CheckListComponent" */ './CheckListComponent'),
            props: (route) => ({
                key: this.checklist_shared_module.name + '_checklist_' + parseInt(route.params.checklist_id) + '_ITEM_' + parseInt(route.params.item_id),
                checklist_id: parseInt(route.params.checklist_id),
        ...
        this.routes.push({
            ...
            component: () => import(/* webpackChunkName: "CheckListComponent" */ './CheckListComponent'),
            props: (route) => ({
                key: this.checklist_shared_module.name + '_checklist_' + parseInt(route.params.list_id) + '_ITEM_' + parseInt(route.params.item_id) + '_CHECKPOINT_' + parseInt(route.params.checkpoint_id),
