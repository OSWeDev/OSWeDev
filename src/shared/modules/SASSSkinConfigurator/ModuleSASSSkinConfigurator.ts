...
export default class ModuleSASSSkinConfigurator extends Module {
    ...
    public static DEFAULT_main_background_url: string = '"/public/client/img/background.jpg"';
    ...
    public static DEFAULT_box_title_bg_url: string = '"/public/client/img/field_set_header.png"';
    public static DEFAULT_picto_store_url: string = '"/public/client/img/pictos/storepicto.png"';
    public static DEFAULT_picto_store_info_url: string = '"/public/client/img/pictos/store_info_picto.png"';
    public static DEFAULT_picto_orga_url: string = '"/public/client/img/pictos/picto_orga.png"';
    public static DEFAULT_picto_tool_small_url: string = '"/public/client/img/pictos/picto_tool_small.png"';
    public static DEFAULT_picto_fleche_verte_url: string = '"/public/client/img/pictos/picto_fleche_verte.png"';
    public static DEFAULT_picto_clock_small_url: string = '"/public/client/img/pictos/clock_picto_small.png"';
    public static DEFAULT_picto_objectivos_url: string = '"/public/client/img/pictos/picto_objectivos.png"';
    public static DEFAULT_picto_atteindre_url: string = '"/public/client/img/pictos/picto_atteindre.png"';
    public static DEFAULT_picto_equipe_url: string = '"/public/client/img/picto_equipe.png"';
