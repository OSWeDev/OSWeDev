...
export default class ModuleDataImport extends Module {
    ...
    public initialize() {
        ...
        this.datatable_file = new ModuleTable(this, DataImportFileVO.API_TYPE_ID, datatable_fields, "Fichiers d'import");
        ...
        this.datatable_column = new ModuleTable(this, DataImportColumnVO.API_TYPE_ID, datatable_fields, "Colonnes importées");
        ...
        this.datatable_historic = new ModuleTable(this, DataImportHistoricVO.API_TYPE_ID, datatable_fields, "Historiques d'importation");
        ...
        this.datatable_log = new ModuleTable(this, DataImportLogVO.API_TYPE_ID, datatable_fields, "Logs d'importation");
