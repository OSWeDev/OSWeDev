...
export default class ModuleDataImport extends Module {
    ...
    public initialize() {
        ...
        let datatable_fields = [
            ...
            new ModuleTableField('save_error_logs', ModuleTableField.FIELD_TYPE_boolean, 'Sauvegarde des logs d\'erreur', true, true, false),
        ];
        ...
        let field_dih_id = new ModuleTableField('dih_id', ModuleTableField.FIELD_TYPE_foreign_key, 'Historique', false);
        datatable_fields = [
            label_field,
            field_dih_id
        ];
        let data_error_log = new ModuleTable(this, DataImportErrorLogVO.API_TYPE_ID, () => new DataImportErrorLogVO(), datatable_fields, label_field, "Logs d'importation").hideAnyToManyByDefault();
