...
/**
 * @class VOFilterWidgetOptionsVO
 *  - options for field value filter widget
 */
export default class VOFilterWidgetOptionsVO extends AbstractVO {

    public static VO_FIELD_REF_PLACEHOLDER_CODE_PREFIX: string = "VOFilterWidgetOptions.vo_field_ref.placeholder.";
    public static VO_FIELD_REF_ADVANCED_MODE_PLACEHOLDER_CODE_PREFIX: string = "VOFilterWidgetOptions.vo_field_ref.advanced_mode_placeholder.";

    public static CHECKBOX_COLUMNS_LABELS: string[] = [
        'VOFilterWidgetOptions.CHECKBOX_COLUMNS.1',
        'VOFilterWidgetOptions.CHECKBOX_COLUMNS.2',
        'VOFilterWidgetOptions.CHECKBOX_COLUMNS.3',
        'VOFilterWidgetOptions.CHECKBOX_COLUMNS.4',
        'VOFilterWidgetOptions.CHECKBOX_COLUMNS.6',
        'VOFilterWidgetOptions.CHECKBOX_COLUMNS.12'
    ];
    ...
    public static get_selected_fields(page_widget: DashboardPageWidgetVO): { [api_type_id: string]: { [field_id: string]: boolean } } {
        ...
        let options: VOFilterWidgetOptionsVO = (page_widget && page_widget.json_options) ? JSON.parse(page_widget.json_options) : null;
    ...
    public get_placeholder_name_code_text(page_widget_id: number): string {
        ...
        return VOFilterWidgetOptionsVO.VO_FIELD_REF_PLACEHOLDER_CODE_PREFIX + page_widget_id + '.' + this.vo_field_ref.api_type_id + '.' + this.vo_field_ref.field_id;
    }
    ...
    public get_advanced_mode_placeholder_code_text(page_widget_id: number): string {
        ...
        return VOFilterWidgetOptionsVO.VO_FIELD_REF_ADVANCED_MODE_PLACEHOLDER_CODE_PREFIX + page_widget_id + '.' + this.vo_field_ref.api_type_id + '.' + this.vo_field_ref.field_id;
    }
    ...
    public async get_all_exportable_name_code_and_translation(page_id: number, page_widget_id: number): Promise<{ [current_code_text: string]: string }> {
        ...
        if (placeholder_name_code_text) {
            ...
            res[placeholder_name_code_text] =
                VOFilterWidgetOptionsVO.VO_FIELD_REF_PLACEHOLDER_CODE_PREFIX +
        ...
        if (advanced_mode_placeholder_code_text) {
            ...
            res[advanced_mode_placeholder_code_text] =
                VOFilterWidgetOptionsVO.VO_FIELD_REF_ADVANCED_MODE_PLACEHOLDER_CODE_PREFIX +
                '{{IMPORT:' + DashboardPageWidgetVO.API_TYPE_ID + ':' + page_widget_id + '}}' +
                '.' + this.vo_field_ref.api_type_id + '.' + this.vo_field_ref.field_id;
        }
        return res;
