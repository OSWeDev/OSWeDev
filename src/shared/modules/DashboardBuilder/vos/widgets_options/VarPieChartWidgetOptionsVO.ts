...
export default class VarPieChartWidgetOptionsVO extends WidgetOptionsBaseVO {
    ...
    public legend_font_size: FontSizeVO; // TODO migrated to FontSizeVO
    ...
    // public title_font_size: number; TODO migrated to FontSizeVO in WidgetOptionsBaseVO

    public title_padding: number; // Intégrer dans le widget options base ?
