...
/**
 * SupervisionWidgetOptions
 */
export default class SupervisionWidgetOptions extends AbstractVO {

    public static TITLE_CODE_PREFIX: string = "SupervisionWidgetOptions.title.";
    ...
    public get_title_name_code_text(page_widget_id: number): string {
        ...
        return SupervisionWidgetOptions.TITLE_CODE_PREFIX + page_widget_id + DefaultTranslation.DEFAULT_LABEL_EXTENSION;
    }
    ...
    public async get_all_exportable_name_code_and_translation(page_id: number, page_widget_id: number): Promise<{ [current_code_text: string]: string }> {
        ...
        if (placeholder_name_code_text) {
            ...
            res[placeholder_name_code_text] =
                SupervisionWidgetOptions.TITLE_CODE_PREFIX +
