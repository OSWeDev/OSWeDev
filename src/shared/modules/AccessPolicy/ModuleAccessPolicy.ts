...
export default class ModuleAccessPolicy extends Module {
    ...
    private initializeRole() {
        ...
        this.role_datatable = new ModuleTable(this, RoleVO.API_TYPE_ID, datatable_fields);
    ...
    private initializeUserRoles() {
        ...
        this.userroles_datatable = new ModuleTable(this, UserRolesVO.API_TYPE_ID, datatable_fields);
    ...
    private initializeModuleAccessPolicyGroup() {
        ...
        this.accesspolicygroup_datatable = new ModuleTable(this, AccessPolicyGroupVO.API_TYPE_ID, datatable_fields);
    ...
    private initializeModuleAccessPolicy() {
        ...
        this.accesspolicy_datatable = new ModuleTable(this, AccessPolicyVO.API_TYPE_ID, datatable_fields);
    ...
    private initializeRolesPolicies() {
        ...
        this.rolepolicies_datatable = new ModuleTable(this, RolePoliciesVO.API_TYPE_ID, datatable_fields);
