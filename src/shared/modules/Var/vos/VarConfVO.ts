...
export default class VarConfVO implements INamedVO {
    ...
    public static MEAN_AGGREGATOR: number = 14; // Moyenne : Attention il s'agit d'un aggrégateur non symétrique, on ne peut pas aggréger des sous ensembles, l'aggrégat doit être fait sur l'ensemble des données
    ...
    public static AGGREGATOR_LABELS: { [id: number]: string } = {
        ...
        [VarConfVO.MEAN_AGGREGATOR]: 'var_conf.aggregator.mean',
    };
