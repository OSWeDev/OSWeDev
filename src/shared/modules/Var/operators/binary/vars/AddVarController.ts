...
export default class AddVarController<TDataLeft extends ISimpleNumberVarData, TDataRight extends ISimpleNumberVarData> extends BinaryVarOperatorControllerBase<TDataLeft, TDataRight> {
    ...
    public constructor(
        ...
        super(left_var, AddVarController.OPERATOR_NAME, right_var);
    }
