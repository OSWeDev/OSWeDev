...
export default class TimesVarController<TDataLeft extends ISimpleNumberVarData, TDataRight extends ISimpleNumberVarData> extends BinaryVarOperatorControllerBase<TDataLeft, TDataRight> {
    ...
    public constructor(
        ...
        super(left_var, TimesVarController.OPERATOR_NAME, right_var);
    }
