...
export default class VarsInitController {
    ...
    public register_var_data(
        ...
        var_fields = var_fields.concat([
            ...
            new ModuleTableField('_bdd_only_index', ModuleTableField.FIELD_TYPE_string, 'Index pour recherche exacte', true, false).index().unique(true).readonly(), // TODO FIXME passer obligatoire quand tous les projets ont migrés en V3 ça sera plus simple
        ]);
