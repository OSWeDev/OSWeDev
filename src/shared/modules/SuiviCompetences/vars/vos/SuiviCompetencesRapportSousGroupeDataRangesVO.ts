...
export default class SuiviCompetencesRapportSousGroupeDataRangesVO extends VarDataBaseVO {

    public static API_TYPE_ID: string = "suivi_comp_r_sg_dr";
    ...
    public _type: string = SuiviCompetencesRapportSousGroupeDataRangesVO.API_TYPE_ID;
