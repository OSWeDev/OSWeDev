...
export default class SuiviCompetencesGroupeUserTsRangesDataRangesVO extends VarDataBaseVO {

    public static API_TYPE_ID: string = "suivi_comp_g_u_ts_r_dr";
    ...
    public _type: string = SuiviCompetencesGroupeUserTsRangesDataRangesVO.API_TYPE_ID;
