...
export default abstract class TriggerHook<Conditions, Params, Out> {
    ...
    public async trigger(conditions: Conditions, params: Params): Promise<Out[]> {
        ...
        await StatsController.register_stat('TriggerHook.trigger.' + this.trigger_type_UID + '.' + conditionUID, 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
        ...
        await StatsController.register_stats('TriggerHook.trigger.' + this.trigger_type_UID + '.' + conditionUID + '.time', time_out - time_in,
