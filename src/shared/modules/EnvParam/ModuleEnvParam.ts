...
export default class ModuleEnvParam extends Module {
    ...
    private initializeEnvParamsVO() {
        ...
        ModuleTableFieldController.create_new(EnvParamsVO.API_TYPE_ID, field_names<EnvParamsVO>().dashboard_export_page_id, ModuleTableFieldVO.FIELD_TYPE_int, 'ID de la page d\'export du dashboard', false);
