...
export default class NotificationVO implements IDistantVOBase {
    ...
    public static TYPE_NAMES: string[] = ['notification.TYPE_NOTIF_SIMPLE', 'notification.TYPE_NOTIF_DAO', 'notification.TYPE_NOTIF_HOOK', 'notification.TYPE_NOTIF_VARDATA', 'notification.TYPE_NOTIF_WRAPPER', 'notification.TYPE_NOTIF_TECH', 'notification.TYPE_NOTIF_PROMPT'];
