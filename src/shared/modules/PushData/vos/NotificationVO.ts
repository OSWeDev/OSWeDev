...
export default class NotificationVO implements IDistantVOBase {
    ...
    public static TYPE_NAMES: string[] = ['notification.TYPE_NOTIF_SIMPLE', 'notification.TYPE_NOTIF_DAO', 'notification.TYPE_NOTIF_HOOK', 'notification.TYPE_NOTIF_VARDATA'];
