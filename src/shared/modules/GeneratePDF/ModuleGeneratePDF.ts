...
export default class ModuleGeneratePDF extends Module {
    ...
    */
    public generatePDF: (sous_rep: string, file_name: string, html: string, options: any) => Promise<string> = APIControllerWrapper.sah(ModuleGeneratePDF.APINAME_generatePDF);
