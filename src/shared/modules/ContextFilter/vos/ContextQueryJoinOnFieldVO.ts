...
export default class ContextQueryJoinOnFieldVO implements IDistantVOBase {
    ...
    public static createNew(
        ...
        joined_table_field_id_or_alias: string,
        ...
        res.joined_table_field_id_or_alias = joined_table_field_id_or_alias;
     ...
     */
    public joined_table_field_id_or_alias: string;
    ...
    public log(is_error: boolean = false) {
        ...
        log_func('                          - joined_table_field_id_or_alias: ' + this.joined_table_field_id_or_alias);
