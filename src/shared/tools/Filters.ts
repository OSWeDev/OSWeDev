...
export let toFixedCeilFilter = new FilterObj(
    function (
        ...
        return readToFixedBase(value, fractionalDigits, arrondi, ARRONDI_TYPE_CEIL);
    },
    writeToFixed
);
...
export let toFixedFloorFilter = new FilterObj(
    function (
        ...
        return readToFixedBase(value, fractionalDigits, arrondi, ARRONDI_TYPE_FLOOR);
    },
    writeToFixed
);
...
let readToHourandMinutesFilter = function (value: number): string {
...
let writeToHourAndMinuteFilter = function (value: string): number {
...
export let hourAndMinutesFilter = new FilterObj(
    readToHourandMinutesFilter,
    writeToHourAndMinuteFilter
