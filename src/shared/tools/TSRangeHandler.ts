...
//             min_inclusiv = TimeSegmentHandler.getInstance().getCorrespondingTimeSegment(min_inclusiv, segment_type).index;
...
//             // FIXME : needs rework for timesegments < day
//             max_inclusiv = TimeSegmentHandler.getInstance().getCorrespondingTimeSegment(max_inclusiv, segment_type).index;
