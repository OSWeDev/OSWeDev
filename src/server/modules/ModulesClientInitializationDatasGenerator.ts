...
export default class ModulesClientInitializationDatasGenerator {
    ...
    private getFileContent(target: string) {
        ...
        fileContent += "    EnvHandler.NODE_VERBOSE = " + ((!!ConfigurationService.getInstance().node_configuration.NODE_VERBOSE) ? 'true' : 'false') + ';\n';
        fileContent += "    EnvHandler.IS_DEV = " + ((!!ConfigurationService.getInstance().node_configuration.ISDEV) ? 'true' : 'false') + ';\n';
        fileContent += "    EnvHandler.MSGPCK = " + ((!!ConfigurationService.getInstance().node_configuration.MSGPCK) ? 'true' : 'false') + ';\n';
        fileContent += "    EnvHandler.COMPRESS = " + ((!!ConfigurationService.getInstance().node_configuration.COMPRESS) ? 'true' : 'false') + ';\n';
        fileContent += "    EnvHandler.BASE_URL = '" + ConfigurationService.getInstance().node_configuration.BASE_URL + "';\n";
        fileContent += "    EnvHandler.CODE_GOOGLE_ANALYTICS = '" + ConfigurationService.getInstance().node_configuration.CODE_GOOGLE_ANALYTICS + "';\n";
        fileContent += "    EnvHandler.VERSION = '" + GeneratorBase.getInstance().getVersion() + "';\n";
        fileContent += "    EnvHandler.ACTIVATE_PWA = " + ((!!ConfigurationService.getInstance().node_configuration.ACTIVATE_PWA) ? 'true' : 'false') + ';\n';
