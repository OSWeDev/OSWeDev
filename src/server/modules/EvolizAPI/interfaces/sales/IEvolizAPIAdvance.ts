export default interface IEvolizAPIAdvance {
    advanceid: number;
...
// Generated by Copilot, using the following code as a prompt (from https://evoliz.io/documentation#section/Advance-resources (v1.24 in https://evoliz.io/changelog)):
// {
//     "advanceid": 26263,
