...
export default class ModuleDashboardBuilderServer extends ModuleServerBase {
    ...
    public async configure() {
        ...
        }, 'var_mixed_charts_widget_options_component.switch_style.___LABEL___'));

        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({
            'fr-fr': 'Detaillé'
        }, 'var_mixed_charts_widget_options_component.switch_style.detailed.___LABEL___'));

        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({
            'fr-fr': 'Simple'
        }, 'var_mixed_charts_widget_options_component.switch_style.simple.___LABEL___'));
