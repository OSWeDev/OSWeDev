...
export default class ModuleAnimationServer extends ModuleServerBase {
    ...
    private async initializeTranslations() {
        ...
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'utilisateur id requis manquant', 'en-us': 'missing required user id' }, 'animation.reset.no_user_ids.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'module id requis manquant', 'en-us': 'missing required module id' }, 'animation.reset.no_module_ids.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'Remise à zéro des modules du thème', 'en-us': 'Reset of the theme modules' }, 'animation.theme.reset.tooltip.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'Remise à zéro du module', 'en-us': 'Reset of the module' }, 'animation.module.reset.tooltip.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'Confirmation', 'en-us': 'Confirmation' }, 'animation.theme.reset.title.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'Remise à zéro des modules du thème', 'en-us': 'Reset of the theme modules' }, 'animation.theme.reset.body.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'OK : Remise à zéro des modules du thème', 'en-us': 'OK: Reset of the theme modules' }, 'animation.theme.reset.success.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'Confirmation', 'en-us': 'Confirmation' }, 'animation.module.reset.title.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'Remise à zéro du module', 'en-us': 'Reset of the module' }, 'animation.module.reset.body.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'OK : Remise à zéro du module', 'en-us': 'OK: Reset of the module' }, 'animation.module.reset.success.___LABEL___'));
        DefaultTranslationManager.registerDefaultTranslation(DefaultTranslationVO.create_new({ 'fr-fr': 'OK : Remise à zéro en cours', 'en-us': 'OK: Reset in progress' }, 'animation.module.reset.async.wip.___LABEL___'));
    }
