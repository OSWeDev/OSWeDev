...
export default class VarsCacheController {
    ...
    //     let var_cache_conf = VarsServerController.varcacheconf_by_var_ids[node.var_data.var_id];
    ...
    //         let var_cache_conf: VarCacheConfVO = VarsServerController.varcacheconf_by_var_ids[var_id];
    ...
    //             if (VarsDatasProxy.has_cached_index(var_data.index)) {
    //                 continue;
    //             }
