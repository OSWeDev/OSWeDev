...
//             let varcacheconf = VarsServerController.varcacheconf_by_var_ids[varconf.id];
...
//                 ' on [' + last_x_perf.var_id + '] ' + VarsServerController.getVarConfById(last_x_perf.var_id).name);
//         }
...
//                 ' on ' + (last_x_var_perfs ? '[' + last_x_var_perfs[0].var_id + '] ' + VarsServerController.getVarConfById(last_x_var_perfs[0].var_id).name : 'N/A'));
//         }
...
//                     ' on [' + last_x_var_perf.var_id + '] ' + VarsServerController.getVarConfById(last_x_var_perf.var_id).name +
