    ...
    private async handleHistoric(exhi: ExportHistoricVO): Promise<boolean> {
        ...
        try {
            ...
            if (!!exhi.export_to_uid) {
                PushDataServerController.getInstance().notifySimpleINFO(exhi.export_to_uid, "DataExportBGThread.handleHistoric.start");
            }
            ...
            if (!!exhi.export_to_uid) {
                PushDataServerController.getInstance().notifySimpleSUCCESS(exhi.export_to_uid, "DataExportBGThread.handleHistoric.success");
            }
            ...
            if (!!exhi.export_to_uid) {
                PushDataServerController.getInstance().notifySimpleERROR(exhi.export_to_uid, "DataExportBGThread.handleHistoric.failed");
            }
