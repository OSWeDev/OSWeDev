...
export default class DataExportBGThread implements IBGThread {
    ...
    public async work(): Promise<number> {
        ...
        try {
            ...
            StatsServerController.register_stat('DataExportBGThread.work.IN', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private stats_out(activity: string, time_in: number) {
        ...
        StatsServerController.register_stat('DataExportBGThread.work.' + activity + '.OUT.nb', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
        StatsServerController.register_stats('DataExportBGThread.work.' + activity + '.OUT.time', time_out - time_in,
