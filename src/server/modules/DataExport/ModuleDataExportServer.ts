...
export default class ModuleDataExportServer extends ModuleServerBase {
    ...
    public async configure() {
        ...
        preCreateTrigger.registerHandler(ExportContextQueryToXLSXQueryVO.API_TYPE_ID, this, this.handleTriggerExportContextQueryToXLSXQueryVOCreate);
    ...
    private async handleTriggerExportContextQueryToXLSXQueryVOCreate(ex: ExportContextQueryToXLSXQueryVO): Promise<boolean> {

        ex.creation_date = Dates.now();
        return true;
    }
