let template: string = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
    ...
    '                                        <a href="%%VAR%%FILE_URL%%" style="border: 3px solid #eeeeee; color: #969696; text-decoration: none; padding: 15px 45px; text-transform: uppercase; display: block; text-align: center; font-size: 16px;">' +
    '                                           %%TRAD%%export.default_mail.download%%' +
    '                                        </a>' +
    '                                    </td>' +
    '                                </tr>' +
    '                            </table>' +
