...
export default class ModuleTableDBService {
    ...
    public async get_existing_segmentations_tables_of_moduletable(moduleTable: ModuleTable<any>): Promise<{ [segmented_value: number]: string }> {
        ...
        await StatsController.register_stat('ModuleTableDBService.get_existing_segmentations_tables_of_moduletable', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    public async create_or_update_datatable(moduleTable: ModuleTable<any>, segments: IRange[] = null) {
        ...
        await StatsController.register_stat('ModuleTableDBService.create_or_update_datatable', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async handle_check_segment(moduleTable: ModuleTable<any>, segmented_value: number, common_id_seq_name: string, migration_todo: boolean): Promise<boolean> {
        ...
        await StatsController.register_stat('ModuleTableDBService.handle_check_segment', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async do_check_or_update_moduletable(moduleTable: ModuleTable<any>, database_name: string, table_name: string, segmented_value: number): Promise<boolean> {
        ...
        await StatsController.register_stat('ModuleTableDBService.do_check_or_update_moduletable', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async check_datatable_structure(moduleTable: ModuleTable<any>, database_name: string, table_name: string, table_cols: TableColumnDescriptor[]): Promise<boolean> {
        ...
        await StatsController.register_stat('ModuleTableDBService.check_datatable_structure', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async checkConstraintsOnForeignKey(
        ...
        await StatsController.register_stat('ModuleTableDBService.checkConstraintsOnForeignKey', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async checkMissingInTS(
        ...
        await StatsController.register_stat('ModuleTableDBService.checkMissingInTS', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async checkMissingInDB(
        ...
        await StatsController.register_stat('ModuleTableDBService.checkMissingInDB', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async checkColumnsStrutInDB(
        ...
        await StatsController.register_stat('ModuleTableDBService.checkColumnsStrutInDB', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async chec_indexes(moduleTable: ModuleTable<any>, database_name: string, table_name: string): Promise<boolean> {
        ...
        await StatsController.register_stat('ModuleTableDBService.chec_indexes', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
    ...
    private async create_new_datatable(moduleTable: ModuleTable<any>, database_name: string, table_name: string) {
        ...
        await StatsController.register_stat('ModuleTableDBService.create_new_datatable', 1, StatVO.AGGREGATOR_SUM, TimeSegment.TYPE_MINUTE);
