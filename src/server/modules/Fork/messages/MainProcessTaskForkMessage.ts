...
export default class MainProcessTaskForkMessage implements IForkMessage {
     ...
     */
    public constructor(public message_content: string, public message_content_params: any, public callback_forked_uid: number = null, public callback_id: string = null) { }
}